...
namespace UnknownIndustries.Patches
{
    public static class PatchDataHandler
    {
        ...
        static class Patch_DataHandler_Init
        {
            static void Postfix()
            {
                UI.arrowUp = UI.LoadPNG("UnknownIndustries/images/mod_menu/arrow_up.png");
                UI.arrowDown = UI.LoadPNG("UnknownIndustries/images/mod_menu/arrow_down.png");
                UI.enable = UI.LoadPNG("UnknownIndustries/images/mod_menu/enable.png");
                UI.disable = UI.LoadPNG("UnknownIndustries/images/mod_menu/disable.png");
            }
        }
